 ...
 */
function writeSuggestions(dir, filename, records) {
...
describe('merge-structure command', () => {
    ...
    it('applies add_relation suggestion — adds a new edge', async () => {
        ...
        const outputGraph = JSON.parse(fs.readFileSync(outputPath, 'utf-8'));
...
//# sourceMappingURL=merge-structure.test.js.map