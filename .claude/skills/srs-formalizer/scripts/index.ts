...
const COMMAND_GROUPS: CommandGroup[] = [
  {
    ...
    commands: [
      ...
      { name: "validate-shard-index", desc: "校验 _ctx/shard_index.json schema (ShardIndex v1.0/1.1)", usage: "validate-shard-index --workdir .srs_formalizer" },
...
> = {
  ...
  "validate-shard-index": () => import("./commands/validate-shard-index.js"),
