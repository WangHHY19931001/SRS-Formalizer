...
function hasAffirmation(text: string): boolean {
 ...
 */
function isAntonymPair(textA: string, textB: string): boolean {
 ...
 */
function findSameAspectClusters(
  graph: Graph,
  nodeIds: string[]
 ...
 */
function generateDuplicateAnalysisMd(
 ...
 */
function generateConflictAnalysisMd(
 ...
 */
function generateAspectAnalysisMd(
...
export async function main(args: string[]): Promise<CliResult> {
  ...
  for (const n of reqNodes) {
    reqStatements.set(n.id, (n.properties.statement as string) ?? '');
  }
